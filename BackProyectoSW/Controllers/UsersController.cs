    ...
    namespace BackProyectoSW.Controllers
    {
        ...
        public IHttpActionResult GetUserData([FromBody] Users users)
        {
            UsersManager userManager = new UsersManager();
            ...
            // Asegúrate de que estás devolviendo un objeto con una propiedad 'Role'
            return Ok(new { Role = user[0].RoleName });
        }
